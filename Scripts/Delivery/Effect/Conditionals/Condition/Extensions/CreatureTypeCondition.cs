...
namespace Delivery
{
    public class CreatureTypeCondition : Condition
    {
        ...
        public override bool Apply(GameObject owner, GameObject target, I_DeliveryPack pack, I_DeliveryPack newPack, List<Result> results, Dictionary<Delivery_Pack_Shifts, NumberShift> shifts) {
