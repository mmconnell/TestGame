...
namespace Enums.CharacterStatus
{
    public class CharacterAttributes
    {
        ...
        public static CharacterAttribute SHOCK_RESISTANCE = new CharacterAttribute(Character_Attribute_Enum.SHOCK_RESISTANCE, MAGICAL_RESISTANCE);
        public static CharacterAttribute HEALING_RESISTANCE = new CharacterAttribute(Character_Attribute_Enum.HEALING_RESISTANCE, RESISTANCE);
        ...
        public static CharacterAttribute AURA_RADIUS = new CharacterAttribute(Character_Attribute_Enum.AURA_RADIUS);

        public static readonly Dictionary<Character_Stat, CharacterAttribute> StatToAttribute
            = new Dictionary<Character_Stat, CharacterAttribute>
            {
                { Character_Stat.STRENGTH, STRENGTH },
                { Character_Stat.CONSTITUTION, CONSTITUTION },
                { Character_Stat.DEXTERITY, DEXTERITY },
                { Character_Stat.INTELLIGENCE, INTELLIGENCE },
                { Character_Stat.WISDOM, WISDOM },
                { Character_Stat.CHARISMA, CHARISMA }
            };
    }
