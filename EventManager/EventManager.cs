...
public class EventManager : MonoBehaviour
{
    ...
    private Dictionary<GameObject, Dictionary<string, UnityEvent>> LocalEvents;
    ...
    void Init()
    {
        if (GlobalEvents == null)
        {
            ...
            LocalEvents = new Dictionary<GameObject, Dictionary<string, UnityEvent>>();
        }
    }
    ...
    public static void StartListening(GameObject gameObject, string eventName, UnityAction listener)
    {
        ...
        if(Instance.LocalEvents.TryGetValue(gameObject, out dictionary))
        {
        ...
        else
        {
            ...
            Instance.LocalEvents[gameObject] = dictionary;
        }
    }
