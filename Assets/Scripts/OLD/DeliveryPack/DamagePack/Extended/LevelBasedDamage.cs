...
public class LevelBasedDamageOld : DamagePackOld
{
    private DamagePackOld DamagePack { get; set; }
    private bool SourceIsOwner { get; set; }

    public LevelBasedDamageOld(DamageType damageType, DamagePackOld damagePack, bool sourceIsOwner) : base(damageType)
    {
